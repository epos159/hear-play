...
export const PLACEMENT_TEST = [
  {
    ...
    question: "What note is this on the treble staff? (second line)",
    options: ["C", "G", "E", "B"],
    correct: 2,
    difficulty: 0,
  },
  {
    id: "major-scale",
    type: "audio",
    question: "Play the C major scale. What's this pattern called?",
    options: ["major scale", "minor scale", "pentatonic", "chromatic"],
    correct: 0,
    difficulty: 0,
  },
  {
  ...
  },
  {
    ...
    type: "audio",
    question: "Does this progression feel finished or still going?",
    options: ["finished (V-I)", "still going (I-V)"],
    correct: 0,
    difficulty: 2,
  },
  {
    ...
    type: "audio",
    question: "What type of cadence is this?",
